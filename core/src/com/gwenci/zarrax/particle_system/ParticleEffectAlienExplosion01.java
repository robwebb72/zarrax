...
public class ParticleEffectAlienExplosion01 extends EmitterType {

	public ParticleEffectAlienExplosion01(int colour) {
		...
		particleTypes.add (new ParticleType(
				...
				life_left_pc -> ParticleFunctionLibrary.ALIEN_EXP_COL_1.apply(life_left_pc, colour),
				life_left_pc -> ParticleFunctionLibrary.ALIEN_EXP_SIZE_1.apply(life_left_pc, 2),
